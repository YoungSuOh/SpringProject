...
<body>
	<div id="list-jsp">
		<div id="left">
			<div id="header">
				<a href="/spring/"> <img src="../image/logo.jpeg"
					alt="Alarm Logo" alt="logo" width="50" height="50" /> HOME
				</a>
			</div>
			<div id="profile">
			...
			<div id="container">
				...
				<div id="table">
					<table>
						...
						<tbody>
							<c:forEach var="userDTO" items="${list.list}">
								<tr>
									<td>${userDTO.name}</td>
									<td><a href="/spring/user/updateForm?id=${userDTO.id}&pg=${list.pg}">${userDTO.id}</td>
									<td>${userDTO.pwd}</td>
								</tr>
							</c:forEach>
						</tbody>
				...
				<div id="page-block">${list.userPaging.pagingHTML }</div>
			</div>
